      ...
      <section id={abc.mainform}>
        ...
        <table id={abc.table}>
            ...
            <tr>
              ...
              <td><input type="text" value={name} ref={nameref} onChange={getName} /></td>
            </tr>
            <tr>
              <td><label htmlFor="">Salary: </label></td>
              <td><input type="text" value={salary} ref={salaryref} onChange={getSalary}/></td>
            </tr>
            <tr>
              <td><label htmlFor="">Company: </label></td>
              <td><input type="text" value={company} ref={companyref} onChange={getCompany}/></td>
            </tr>
            <th colSpan="2" id={abc.buttr}><button id={abc.button} disabled={disable} onClick={formHandle}>
